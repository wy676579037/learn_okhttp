...
package learn.io.reactivex.flowables;
...
import learn.io.reactivex.internal.util.ConnectConsumer;
...
public abstract class ConnectableFlowable<T> extends Flowable<T> {
     ...
     * {@link Flowable} to its {@link Subscriber}s.
     * <p>
     * To disconnect from a synchronous source, use the {@link #connect(learn.io.reactivex.functions.Consumer)} method.
     *
