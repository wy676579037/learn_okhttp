...
import learn.io.reactivex.internal.fuseable.ScalarCallable;
import learn.io.reactivex.internal.observers.*;
import learn.io.reactivex.internal.operators.flowable.*;
import learn.io.reactivex.internal.operators.observable.*;
import learn.io.reactivex.internal.util.*;
import learn.io.reactivex.observables.*;
import learn.io.reactivex.observers.*;
import learn.io.reactivex.plugins.RxJavaPlugins;
import learn.io.reactivex.schedulers.*;
 ...
 * {@code Subscription} with {@link Disposable} as the primary means to cancel
 * a flow.
 * <p>
 ...
 * @see Flowable
 * @see learn.io.reactivex.observers.DisposableObserver
 */
public abstract class Observable<T> implements ObservableSource<T> {
     ...
     * <p>Allows hiding extra features such as {@link learn.io.reactivex.subjects.Subject}'s
