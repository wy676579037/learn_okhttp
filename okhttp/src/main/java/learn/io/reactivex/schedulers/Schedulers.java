...
import learn.io.reactivex.Scheduler;
import learn.io.reactivex.annotations.NonNull;
import learn.io.reactivex.internal.schedulers.*;
 ...
 * <ul>
 * <li>{@code rx2.learn.io-priority} (int): sets the thread priority of the {@link #io()} Scheduler, default is {@link Thread#NORM_PRIORITY}</li>
...
public final class Schedulers {
     ...
     * <p>
     * This type of scheduler is less sensitive to leaking {@link learn.io.reactivex.Scheduler.Worker} instances, although
     ...
     * {@link RxJavaPlugins#setInitComputationSchedulerHandler(learn.io.reactivex.functions.Function)} plugin method.
     ...
     * via the {@link RxJavaPlugins#setComputationSchedulerHandler(learn.io.reactivex.functions.Function)} method.
     * <p>
     ...
     * &#64;{@link learn.io.reactivex.annotations.SchedulerSupport SchedulerSupport}({@link learn.io.reactivex.annotations.SchedulerSupport#COMPUTATION COMPUTATION})
     * annotation.
     ...
     * returned by {@link learn.io.reactivex.Scheduler#createWorker()} but otherwise will start a new backing
     ...
     * or when implementing an operator, the Worker instances must be disposed via {@link learn.io.reactivex.Scheduler.Worker#dispose()}.
     * <p>
     ...
     * <p>
     * The default value of this scheduler can be overridden at initialization time via the
     * {@link RxJavaPlugins#setInitIoSchedulerHandler(learn.io.reactivex.functions.Function)} plugin method.
     * Note that due to possible initialization cycles, using any of the other scheduler-returning methods will
     * result in a {@code NullPointerException}.
     * Once the {@link Schedulers} class has been initialized, you can override the returned {@link Scheduler} instance
     * via the {@link RxJavaPlugins#setIoSchedulerHandler(learn.io.reactivex.functions.Function)} method.
     * <p>
     * It is possible to create a fresh instance of this scheduler with a custom ThreadFactory, via the
     ...
     * (J2EE) container to unload properly.
     * <p>Operators on the base reactive classes that use this scheduler are marked with the
     * &#64;{@link learn.io.reactivex.annotations.SchedulerSupport SchedulerSupport}({@link learn.io.reactivex.annotations.SchedulerSupport#IO IO})
     * annotation.
    ...
    /**
     * Returns a default, shared {@link Scheduler} instance whose {@link learn.io.reactivex.Scheduler.Worker}
     ...
     * the Worker instances must be disposed via {@link learn.io.reactivex.Scheduler.Worker#dispose()}.
     * <p>
     * Unhandled errors will be delivered to the scheduler Thread's {@link java.lang.Thread.UncaughtExceptionHandler}.
     * <p>
     * You can control certain properties of this standard scheduler via system properties that have to be set
     ...
     * <p>
     * The default value of this scheduler can be overridden at initialization time via the
     * {@link RxJavaPlugins#setInitNewThreadSchedulerHandler(learn.io.reactivex.functions.Function)} plugin method.
     * Note that due to possible initialization cycles, using any of the other scheduler-returning methods will
     * result in a {@code NullPointerException}.
     * Once the {@link Schedulers} class has been initialized, you can override the returned {@link Scheduler} instance
     * via the {@link RxJavaPlugins#setNewThreadSchedulerHandler(learn.io.reactivex.functions.Function)} method.
     * <p>
     * It is possible to create a fresh instance of this scheduler with a custom ThreadFactory, via the
     ...
     * (J2EE) container to unload properly.
     * <p>Operators on the base reactive classes that use this scheduler are marked with the
     * &#64;{@link learn.io.reactivex.annotations.SchedulerSupport SchedulerSupport}({@link learn.io.reactivex.annotations.SchedulerSupport#NEW_THREAD NEW_TRHEAD})
     * annotation.
     ...
     * <p>
     * The default value of this scheduler can be overridden at initialization time via the
     * {@link RxJavaPlugins#setInitSingleSchedulerHandler(learn.io.reactivex.functions.Function)} plugin method.
     * Note that due to possible initialization cycles, using any of the other scheduler-returning methods will
     * result in a {@code NullPointerException}.
     * Once the {@link Schedulers} class has been initialized, you can override the returned {@link Scheduler} instance
     * via the {@link RxJavaPlugins#setSingleSchedulerHandler(learn.io.reactivex.functions.Function)} method.
     * <p>
     * It is possible to create a fresh instance of this scheduler with a custom ThreadFactory, via the
     ...
     * (J2EE) container to unload properly.
     * <p>Operators on the base reactive classes that use this scheduler are marked with the
     * &#64;{@link learn.io.reactivex.annotations.SchedulerSupport SchedulerSupport}({@link learn.io.reactivex.annotations.SchedulerSupport#SINGLE SINGLE})
     * annotation.
     ...
     * {@link learn.io.reactivex.disposables.Disposable#dispose()}. In addition, tasks scheduled with
     * a time delay or periodically will use the {@link #single()} scheduler for the timed waiting
     * before posting the actual task to the given executor.
     * <p>
