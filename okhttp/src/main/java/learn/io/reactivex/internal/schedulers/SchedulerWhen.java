 ...
 */
package learn.io.reactivex.internal.schedulers;

import java.util.concurrent.TimeUnit;
import java.util.concurrent.atomic.AtomicBoolean;
import java.util.concurrent.atomic.AtomicReference;

import learn.io.reactivex.Completable;
...
import learn.io.reactivex.annotations.Experimental;
import learn.io.reactivex.annotations.NonNull;
import learn.io.reactivex.disposables.Disposable;
import learn.io.reactivex.disposables.Disposables;
import learn.io.reactivex.exceptions.Exceptions;
import learn.io.reactivex.functions.Function;
import learn.io.reactivex.processors.FlowableProcessor;
import learn.io.reactivex.processors.UnicastProcessor;
 ...
 * <p>
 * When the {@link learn.io.reactivex.Scheduler.Worker Worker} is unsubscribed the {@link Completable} emits an
 ...
 * the number of concurrent {@link learn.io.reactivex.Scheduler.Worker Worker}s rather than individual actions.
 * Generally each {@link Observable} uses its own {@link learn.io.reactivex.Scheduler.Worker Worker}. This means
 * that this will essentially limit the number of concurrent subscribes. The
 * danger comes from using operators like
 * {@link Flowable#zip(Publisher, Publisher, learn.io.reactivex.functions.BiFunction)} where
