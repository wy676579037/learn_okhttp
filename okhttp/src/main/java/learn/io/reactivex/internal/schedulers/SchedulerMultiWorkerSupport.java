 ...
 * {@link learn.io.reactivex.Scheduler} in a way that when asking for
 * at most the parallelism level of the Scheduler, those
 * {@link learn.io.reactivex.Scheduler.Worker} instances will be running
...
public interface SchedulerMultiWorkerSupport {
    ...
    /**
     * Creates the given number of {@link learn.io.reactivex.Scheduler.Worker} instances
