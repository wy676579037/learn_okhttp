...
package learn.io.reactivex.annotations;
...
public @interface SchedulerSupport {
     ...
     */
    String NEW_THREAD = "learn.io.reactivex:new-thread";
    /**
     * The operator/class runs on RxJava's {@linkplain Schedulers#trampoline() trampoline scheduler}
     * or takes timing information from it.
     */
    String TRAMPOLINE = "learn.io.reactivex:trampoline";
    /**
     ...
     */
    @Experimental
    String SINGLE = "learn.io.reactivex:single";
