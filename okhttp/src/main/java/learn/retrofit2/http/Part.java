 ...
 * <ul>
 * <li>If the type is {@link learn.okhttp3.MultipartBody.Part} the contents will be used directly. Omit
 * the name from the annotation (i.e., {@code @Part MultipartBody.Part part}).</li>
 * <li>If the type is {@link learn.okhttp3.RequestBody RequestBody} the value will be used
...
public @interface Part {
   ...
   * {@link learn.okhttp3.MultipartBody.Part}.
   */
